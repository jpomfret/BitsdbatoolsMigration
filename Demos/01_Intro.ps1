...
Get-Help Test-DbaDbCompression -ShowWindow # works nicely on windows
Get-Help Test-DbaDbCompression -Online

## 8. Intro to Splatting
Get-DbaDbCompression -SqlInstance $dbatools1 -Database "pubs"  | Select-Object -first 5
...
# Onward to a simple migration!
code /workspace/Demos/02_SimpleDatabaseMigration.ps1